...
public class AuditLogEntry<T extends ActionData> {
     ...
     */
    public AuditLogEntry(@NotNull SimpleAuditUser user, @Nullable UUID sessionId, @NotNull String applicationGroup, @NotNull String applicationId, @NotNull Instant timestamp, @NotNull Action<T> action, @NotNull T data) {
        this.user = user;
