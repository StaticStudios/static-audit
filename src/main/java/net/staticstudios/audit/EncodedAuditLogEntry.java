...
public class EncodedAuditLogEntry {
    private final @NotNull SimpleAuditUser user;
    ...
    public EncodedAuditLogEntry(@NotNull SimpleAuditUser user, @Nullable UUID sessionId, @NotNull String applicationGroup, @NotNull String applicationId, @NotNull Instant timestamp, @NotNull String actionId, @NotNull String encodedData) {
        this.user = user;
    ...
    public @NotNull SimpleAuditUser getUser() {
        return user;
    }
