...
public class LoggingTest extends AuditTest {
    ...
    private SimpleAuditUser auditUser;
    ...
    public void setUp() {
        ...
        auditUser = SimpleAuditUser.of(UUID.randomUUID());
    ...
    public void testLogging() throws SQLException {
        ...
        statement.setObject(1, auditUser.getAuditId());
    ...
    public void testRetrievingEncodedWithUnknownAction() throws SQLException {
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            ...
            statement.setObject(6, auditUser.getAuditId());
